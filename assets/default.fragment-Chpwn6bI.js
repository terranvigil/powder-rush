import{S as e}from"./index-CD7xsly0.js";import"./mainUVVaryingDeclaration-CwrxsSCr.js";import"./meshUboDeclaration-C3IbYptM.js";const o="decalFragmentDeclaration",w=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=w);const t="defaultFragmentDeclaration",L=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=L);const a="prePassDeclaration",A=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=A);const r="oitDeclaration",I=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=I);const n="lightFragmentDeclaration",T=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=T);const l="lightUboDeclaration",P=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=x);const s="lightsFragmentFunctions",X=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=X);const d="shadowsFragmentFunctions",F=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=F);const c="samplerFragmentDeclaration",M=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=M);const h="fresnelFunction",R=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=R);const v="reflectionFunction",N=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=N);const u="bumpFragmentMainFunctions",y=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=y);const p="bumpFragmentFunctions",O=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=O);const m="bumpFragment",_=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=_);const S="decalFragment",b=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=b);const g="depthPrePass",U=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=U);const E="lightFragment",W=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=W);const C="oitFragment",z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=z);const i="defaultPixelShader",D=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=D);const B={name:i,shader:D};export{B as defaultPixelShader};
