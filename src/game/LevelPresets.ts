...
export const LEVELS: LevelPreset[] = [
  ...
  // Level 8: Powder Bowl — dawn terrain park, tons of jumps
  {
    name: "POWDER BOWL",
    subtitle: "Terrain Park",
    courseType: "terrainPark",
    ...
    sunAzimuth: -80,
    sunElevation: 8,
    sunColor: [1.0, 0.72, 0.4],
    sunIntensity: 1.3,
    ambientIntensity: 0.28,
    groundColor: [0.42, 0.35, 0.48],
    clearColor: [0.35, 0.35, 0.6],
    fogStart: 100,
    fogEnd: 350,
    fogColor: [0.55, 0.48, 0.6],
    snowRate: 5,
    terrainConfig: { jumpCount: 14 },
  },
  // Level 9: Storm Chaser — blizzard downhill, near-zero visibility
  {
    name: "STORM CHASER",
    subtitle: "Downhill",
    courseType: "downhill",
    ...
    sunAzimuth: 10,
    sunElevation: 18,
    sunColor: [0.7, 0.72, 0.78],
    sunIntensity: 0.6,
    ambientIntensity: 0.18,
    groundColor: [0.28, 0.30, 0.42],
    clearColor: [0.32, 0.35, 0.42],
    fogStart: 20,
    fogEnd: 90,
    fogColor: [0.38, 0.40, 0.48],
    snowRate: 60,
    terrainConfig: { mogulIntensity: 0.3 },
  },
];
